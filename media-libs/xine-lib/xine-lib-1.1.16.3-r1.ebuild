...
RDEPEND="X? ( x11-libs/libXext[$(get_ml_usedeps)]
	...
	vorbis? ( media-libs/libogg[$(get_ml_usedeps)] media-libs/libvorbis[$(get_ml_usedeps)] )
	theora? ( media-libs/libogg[$(get_ml_usedeps)?] media-libs/libvorbis[$(get_ml_usedeps)] >=media-libs/libtheora-1.0_alpha6[$(get_ml_usedeps)] )
	speex? ( media-libs/libogg[$(get_ml_usedeps)?] media-libs/libvorbis[$(get_ml_usedeps)] media-libs/speex[$(get_ml_usedeps)] )
	...
	truetype? ( =media-libs/freetype-2*[$(get_ml_usedeps)] media-libs/fontconfig[$(get_ml_usedeps)] )
	virtual/libiconv
